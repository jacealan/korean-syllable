...
// }
function koreanSyllable(length, withspace) {
    if (length === void 0) { length = 1; }
    if (withspace === void 0) { withspace = false; }
    var koreanSyllables = "";
    // str += String.fromCharCode(44032)
    // str += String.fromCharCode(55203)
    for (var i = 0; i < length; i++) {
        ...
        // str += getRandomHangulSyllable()
        // str += `\\u{${getRandomHangulSyllable()}}`
        koreanSyllables += String.fromCharCode(getRandomIntInclusive(44032, 55203));
    }
    return koreanSyllables;
}
exports.koreanSyllable = koreanSyllable;
// let str: string = `
//   계절이 지나가는 하늘에는
//   가을로 가득 차 있습니다.
//   나는 아무 걱정도 없이
